...
namespace ExceptionGuardClauses
{
    public static class ThrowingExceptions
    {
        ...
        public static string GenerateGreeting(string hello, string[] addressee, int index)
        {
            ...
            {
                throw new ArgumentException($"{nameof(addressee)} is null.", nameof(addressee));
            }

            if (index < 0 || index >= addressee.Length)
            {
                throw new ArgumentOutOfRangeException(nameof(index), $"{nameof(index)} should be greater than zero and less than 100");
            }
        ...
        public static string GetArrayValue(int[] indexArray, int indexArrayPosition, string[] valueArray)
        {
            ...
            {
                throw new ArgumentException($"{nameof(indexArray)} is null.", nameof(indexArray));
            }
            ...
            {
                throw new ArgumentException($"{nameof(indexArrayPosition)} is out of range.");
            }
