...
namespace Strings
{
    public static class CopyingStrings
    {
        ...
        public static string CopyFiveChars(string source, string destination)
        {
            ...
            source.CopyTo(0, destinationArray, 3 + 1, source.Length);
        ...
        {
            char[] destianationArray = template.ToCharArray();

            regionCode.CopyTo(1, destianationArray, 0, 1);
            locationCode.CopyTo(4, destianationArray, 3, 2);
            dateCode.CopyTo(3, destianationArray, 7, 3);
            factoryCode.CopyTo(2, destianationArray, 12, 4);

            return new string(destianationArray);
        }
    }
}
